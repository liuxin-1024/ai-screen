<template>
  <div class="text" :style="styleColor">
    <marquee behavior="" :scrollamount="styleColor.direction">{{
      styleColor.text
    }}</marquee>
  </div>
</template>
  ...
  computed: {
    ...
    styleColor() {
      ...
      return {
        ...
        'line-height': this.transStyle.verticalCentering ? this.transStyle.height + "px" : '',
        left: this.transStyle.left + "px",
        top: this.transStyle.top + "px",
        right: this.transStyle.right + "px",
        marqueeSet: this.transStyle.marqueeSet,
        styleColor: this.transStyle.marqueeQuit,
        direction:this.transStyle.jScrollPane,
      };
    },
    allComponentLinkage() {
